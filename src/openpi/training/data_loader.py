...
def transform_dataset(dataset: Dataset, data_config: _config.DataConfig, *, skip_norm_stats: bool = False, is_training: bool = False) -> Dataset:
    """Apply normalization and model transforms to the raw dataset."""
...
def create_data_loader(
    ...
    *,
    ...
    if val_dataset is not None:
        val_dataset = transform_dataset(val_dataset, data_config.create_val_config(), skip_norm_stats=skip_norm_stats, is_training=False)
